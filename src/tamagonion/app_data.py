...
class AppData:
    ...
    def update(self) -> None:
        self._get_flags()
        self._get_uptime()
        self._get_num_streams()
        self._get_num_circuits()
        self._get_pid()
        self._get_info()
    ...
    def _get_num_streams(self) -> None:
        self.num_streams = len(self.relay_manager.controller.get_streams())

    def _get_num_circuits(self) -> None:
        self.num_circuits = len(self.relay_manager.controller.get_circuits())
    ...
    # def _try_get_info(self, key, default_value):
    #     try:
    #         return self.relay_manager.controller.get_info(key)
